...
Remaining:
- broaden real-parser coverage beyond the currently verified Python/TypeScript/TSX method and top-level shapes into more nested or language-specific constructs
