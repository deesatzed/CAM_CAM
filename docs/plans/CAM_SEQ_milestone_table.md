...
Remaining:
- broaden real-parser coverage beyond the currently verified Python/TypeScript/TSX method, top-level, named default-export, and contract-symbol shapes into more nested or language-specific constructs
