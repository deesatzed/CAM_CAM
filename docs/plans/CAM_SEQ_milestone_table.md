...
- related-failure grouping in the Failure Knowledge API and UI so repeated signatures can be reviewed as causal clusters before schema-level root-cause keys are added
