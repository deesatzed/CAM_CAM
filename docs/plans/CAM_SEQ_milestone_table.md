...
- signed HTTPS webhook submission and HMAC-verified reply ingestion over the same exchange ledger
...
Remaining:
- endpoint allowlists, key rotation, capability negotiation, and durable dead-letter handling remain future hardening
